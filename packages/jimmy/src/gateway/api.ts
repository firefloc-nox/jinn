  ...
  try {
    ...
    if (method === "PATCH" && params) {
      ...
      const updated = updateEmployeeYaml(params.name, {
        ...
        runtimeRef: body.runtimeRef !== undefined ? (body.runtimeRef === null || typeof body.runtimeRef === "string" ? body.runtimeRef : undefined) : undefined,
        profileRef: body.profileRef !== undefined ? (body.profileRef === null || (typeof body.profileRef === "object" && typeof body.profileRef?.runtime === "string" && typeof body.profileRef?.name === "string") ? body.profileRef : undefined) : undefined,
        ...
        hermesHooks: body.hermesHooks !== undefined ? (body.hermesHooks === null || typeof body.hermesHooks?.enabled === "boolean" ? body.hermesHooks : undefined) : undefined,
    ...
    if (method === "POST" && pathname === "/api/org/employees") {
      ...
      try {
        createEmployeeYaml({
          ...
          engine: typeof body.engine === "string" ? body.engine : (typeof body.runtimeRef === "string" ? body.runtimeRef : "hermes"),
          runtimeRef: typeof body.runtimeRef === "string" ? body.runtimeRef : undefined,
          profileRef: typeof body.profileRef === "object" && typeof body.profileRef?.runtime === "string" && typeof body.profileRef?.name === "string" ? body.profileRef : undefined,
          ...
          fallbackRuntimes: Array.isArray(body.fallbackRuntimes) ? body.fallbackRuntimes : undefined,
          emoji: typeof body.emoji === "string" ? body.emoji : undefined,
          alwaysNotify: typeof body.alwaysNotify === "boolean" ? body.alwaysNotify : undefined,
          mcp: body.mcp !== undefined ? body.mcp : undefined,
          hermesHooks: typeof body.hermesHooks?.enabled === "boolean" ? body.hermesHooks : undefined,
